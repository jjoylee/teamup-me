...
<table id="memberInfo">
      <tr>
            <td rowspan="3" width="100" height="150" style="background-color:#ccc;">사진</td>
            <td width="100">이름</td>
        ...
        <tr>
        	<td colspan="2"> <a href='/account/download?memberId=${memberVO.memberId}'>포트폴리오 보기</a></td>
       </tr>
...
var url = 'D:\upload\' + '${memberVO.portfolio}'
$("#port").attr("href", url);
</script>
