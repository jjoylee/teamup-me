...
public void modifyInfo(Model model, HttpSession session) throws Exception {
  ...
  model.addAttribute("list",service2.readPrize(memberId));   
...
public String findPasswdPOST(MemberVO vo, RedirectAttributes rttr) throws Exception {
	...
	{
		rttr.addFlashAttribute("msg","none");
		return "redirect:/account/findPasswd";
	}
}
...
public String testPost(MemberVO vo, RedirectAttributes rttr) throws Exception {
	logger.info("regist post ...........");
	String yes = "yes";
	rttr.addFlashAttribute("yyyyyy", yes);
